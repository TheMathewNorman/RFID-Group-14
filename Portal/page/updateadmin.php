    ...
    <body bgcolor="#f5f5f5">
        ...
        <?php include "../component/menu.php"; ?>
            ...
            <form action="" method="POST">
                ...
                <tr><td style="text-align:right">Last name: </td><td><input type="text" name="lastname" placeholder="<?php $userInfo['fname']; ?>"></td></tr>
                <tr><td style="text-align:right">Email: </td><td><input type="email" name="email"  placeholder="<?php $userInfo['fname']; ?>"></td></tr>
                <tr><td style="text-align:right">Phone: </td><td><input type="text" name="phone" placeholder="<?php $userInfo['fname']; ?>"></td></tr>
