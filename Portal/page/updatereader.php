<?php
    ...
    if (isset($_POST['reader_name']) || isset($_POST['reader_group']) || isset($_POST['approved'])) {        
        ...
        $database->updateReader($_GET['id'], $_POST['reader_name'], $_POST['reader_group'], $postApprove);
        header("Location: listreaders.php");
    } 
?>
<html>
    ...
    <body>
        ...
        <?php include "../component/menu.php"; ?>
            ...
            <form action="" method="POST">
                ...
                <tr><td></td></tr>
                <tr><td style="text-align:right">Delete:</td><td><input type="checkbox" name="delete" value="1"></td></tr>
