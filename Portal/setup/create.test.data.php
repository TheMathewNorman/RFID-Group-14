...
if ($connection->connect_error) {
    ...
    if (!mysqli_query($connection, $sql)) { die("Error running admins."); }
    //if (!mysqli_query($connection, $sql)) { die("Error running "); }
    ...
    if (!mysqli_query($connection, $sql)) { die("Error running members."); }
    ...
    if (!mysqli_query($connection, $sql)) { die("Error running readers."); }
    ...
    if (!mysqli_query($connection, $sql)) { die("Error running privilege."); }
    ...
    if (!mysqli_query($connection, $sql)) { die("Error running logs."); }
